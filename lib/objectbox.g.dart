...
final _entities = <obx_int.ModelEntity>[
  ...
  obx_int.ModelEntity(
      ...
      relations: <obx_int.ModelRelation>[
        obx_int.ModelRelation(
            ...
            name: 'relationships',
            targetId: const obx_int.IdUid(33, 2389714016099780980))
      ],
      backlinks: <obx_int.ModelBacklink>[
  ...
  obx_int.ModelEntity(
      ...
      backlinks: <obx_int.ModelBacklink>[]),
  obx_int.ModelEntity(
      id: const obx_int.IdUid(31, 1950555748216824811),
      name: 'DHIS2AttributeValue',
      lastPropertyId: const obx_int.IdUid(3, 8837022442682319755),
      flags: 0,
      properties: <obx_int.ModelProperty>[
        obx_int.ModelProperty(
            id: const obx_int.IdUid(1, 7549188776151658187),
            name: 'id',
            type: 6,
            flags: 1),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(2, 4046825531936178190),
            name: 'dataElementId',
            type: 11,
            flags: 520,
            indexId: const obx_int.IdUid(52, 847509702231509681),
            relationTarget: 'D2DataElement'),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(3, 8837022442682319755),
            name: 'trackedEntityAttributeId',
            type: 11,
            flags: 520,
            indexId: const obx_int.IdUid(53, 1429319708909655686),
            relationTarget: 'D2TrackedEntityAttribute')
      ],
      relations: <obx_int.ModelRelation>[],
      backlinks: <obx_int.ModelBacklink>[]),
  obx_int.ModelEntity(
      id: const obx_int.IdUid(32, 7762875921749888060),
      name: 'FromRelationship',
      lastPropertyId: const obx_int.IdUid(7, 1959954803864509963),
      flags: 0,
      properties: <obx_int.ModelProperty>[
        obx_int.ModelProperty(
            id: const obx_int.IdUid(1, 5832479130040771725),
            name: 'id',
            type: 6,
            flags: 1),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(3, 6263109348462774413),
            name: 'enrollmentId',
            type: 11,
            flags: 520,
            indexId: const obx_int.IdUid(69, 7466661408195666103),
            relationTarget: 'D2Enrollment'),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(4, 7841891143317287399),
            name: 'eventId',
            type: 11,
            flags: 520,
            indexId: const obx_int.IdUid(70, 787100066959735052),
            relationTarget: 'D2Event'),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(6, 2677848091201363147),
            name: 'uid',
            type: 9,
            flags: 0),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(7, 1959954803864509963),
            name: 'trackedEntityId',
            type: 11,
            flags: 520,
            indexId: const obx_int.IdUid(83, 1822857832282146272),
            relationTarget: 'TrackedEntity')
      ],
      relations: <obx_int.ModelRelation>[],
      backlinks: <obx_int.ModelBacklink>[]),
  obx_int.ModelEntity(
      id: const obx_int.IdUid(33, 2389714016099780980),
      name: 'Relationship',
      lastPropertyId: const obx_int.IdUid(19, 5688641459870621206),
      flags: 0,
      properties: <obx_int.ModelProperty>[
        obx_int.ModelProperty(
            id: const obx_int.IdUid(1, 3884739214059828484),
            name: 'id',
            type: 6,
            flags: 1),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(4, 728139221694710482),
            name: 'uid',
            type: 9,
            flags: 2080,
            indexId: const obx_int.IdUid(55, 6669082362609259649)),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(5, 9051162778208595655),
            name: 'relationshipName',
            type: 9,
            flags: 0),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(6, 3083240602611988442),
            name: 'bidirectional',
            type: 1,
            flags: 0),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(7, 3918193849015213840),
            name: 'relationshipType',
            type: 9,
            flags: 0),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(10, 4354329426403309722),
            name: 'createdAt',
            type: 10,
            flags: 0),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(11, 6671946046750356365),
            name: 'updatedAt',
            type: 10,
            flags: 0),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(15, 6060292385701169610),
            name: 'toId',
            type: 11,
            flags: 520,
            indexId: const obx_int.IdUid(78, 4413628903678143178),
            relationTarget: 'ToRelationship'),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(16, 4130759143681541526),
            name: 'fromId',
            type: 11,
            flags: 520,
            indexId: const obx_int.IdUid(79, 5608235184790383898),
            relationTarget: 'FromRelationship'),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(17, 4452387469782644429),
            name: 'trackedEntityId',
            type: 11,
            flags: 520,
            indexId: const obx_int.IdUid(80, 5172954086412795156),
            relationTarget: 'TrackedEntity'),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(18, 3662083485185160906),
            name: 'enrollmentId',
            type: 11,
            flags: 520,
            indexId: const obx_int.IdUid(81, 6194277782992654402),
            relationTarget: 'D2Enrollment'),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(19, 5688641459870621206),
            name: 'eventId',
            type: 11,
            flags: 520,
            indexId: const obx_int.IdUid(82, 3590571779487741156),
            relationTarget: 'D2Event')
      ],
      relations: <obx_int.ModelRelation>[],
      backlinks: <obx_int.ModelBacklink>[]),
  obx_int.ModelEntity(
      id: const obx_int.IdUid(34, 6642671730047329437),
      name: 'ToRelationship',
      lastPropertyId: const obx_int.IdUid(7, 8796114370569263164),
      flags: 0,
      properties: <obx_int.ModelProperty>[
        obx_int.ModelProperty(
            id: const obx_int.IdUid(1, 4369043332416227179),
            name: 'id',
            type: 6,
            flags: 1),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(3, 713225359819263091),
            name: 'enrollmentId',
            type: 11,
            flags: 520,
            indexId: const obx_int.IdUid(71, 5718788133248256277),
            relationTarget: 'D2Enrollment'),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(4, 2503959074594191253),
            name: 'eventId',
            type: 11,
            flags: 520,
            indexId: const obx_int.IdUid(72, 748066310239095020),
            relationTarget: 'D2Event'),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(6, 8488264359237383272),
            name: 'uid',
            type: 9,
            flags: 0),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(7, 8796114370569263164),
            name: 'trackedEntityId',
            type: 11,
            flags: 520,
            indexId: const obx_int.IdUid(84, 6203050864459076139),
            relationTarget: 'TrackedEntity')
      ],
      relations: <obx_int.ModelRelation>[],
      backlinks: <obx_int.ModelBacklink>[]),
  obx_int.ModelEntity(
      id: const obx_int.IdUid(35, 5685057996273379050),
      name: 'TrackedEntity',
      lastPropertyId: const obx_int.IdUid(14, 2716010193377614723),
      flags: 0,
      properties: <obx_int.ModelProperty>[
        obx_int.ModelProperty(
            id: const obx_int.IdUid(1, 8912528255139581523),
            name: 'id',
            type: 6,
            flags: 1),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(4, 8038983291310662721),
            name: 'uid',
            type: 9,
            flags: 2080,
            indexId: const obx_int.IdUid(59, 433416381410644288)),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(5, 7507047721000755530),
            name: 'trackedEntityType',
            type: 9,
            flags: 0),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(7, 1945099070100715767),
            name: 'programOwners',
            type: 9,
            flags: 0),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(8, 613895253510243976),
            name: 'orgUnit',
            type: 9,
            flags: 0),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(9, 3561674341253462146),
            name: 'createdAtClient',
            type: 10,
            flags: 0),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(10, 3631353664430662917),
            name: 'potentialDuplicate',
            type: 1,
            flags: 0),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(11, 8407163552694724171),
            name: 'deleted',
            type: 1,
            flags: 0),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(12, 2504752897804572738),
            name: 'inactive',
            type: 1,
            flags: 0),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(13, 8453420416935974719),
            name: 'createdAt',
            type: 10,
            flags: 0),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(14, 2716010193377614723),
            name: 'updatedAt',
            type: 10,
            flags: 0)
      ],
      relations: <obx_int.ModelRelation>[
        obx_int.ModelRelation(
            id: const obx_int.IdUid(24, 1718385365341852697),
            name: 'relationships',
            targetId: const obx_int.IdUid(33, 2389714016099780980)),
        obx_int.ModelRelation(
            id: const obx_int.IdUid(25, 4799506001717016233),
            name: 'attributes',
...
obx_int.ModelDefinition getObjectBoxModel() {
  final model = obx_int.ModelInfo(
      entities: _entities,
      lastEntityId: const obx_int.IdUid(35, 5685057996273379050),
      lastIndexId: const obx_int.IdUid(84, 6203050864459076139),
      lastRelationId: const obx_int.IdUid(26, 6214499177878275374),
  ...
  final bindings = <Type, obx_int.EntityDefinition>{
    ...
    DHIS2AttributeValue: obx_int.EntityDefinition<DHIS2AttributeValue>(
        model: _entities[30],
    ...
    FromRelationship: obx_int.EntityDefinition<FromRelationship>(
        model: _entities[31],
        toOneRelations: (FromRelationship object) =>
            [object.enrollment, object.event, object.trackedEntity],
        ...
        objectFromFB: (obx.Store store, ByteData fbData) {
          ...
          final uidParam = const fb.StringReader(asciiOptimization: true)
              .vTableGet(buffer, rootOffset, 14, '');
          final object = FromRelationship(uid: uidParam)
            ..id = const fb.Int64Reader().vTableGet(buffer, rootOffset, 4, 0);
          object.enrollment.targetId =
              const fb.Int64Reader().vTableGet(buffer, rootOffset, 8, 0);
          object.enrollment.attach(store);
    ...
    Relationship: obx_int.EntityDefinition<Relationship>(
        model: _entities[32],
        ...
        objectToFB: (Relationship object, fb.Builder fbb) {
          ...
          fbb.addInt64(14, object.to.targetId);
          fbb.addInt64(15, object.from.targetId);
          fbb.addInt64(16, object.trackedEntity.targetId);
          fbb.addInt64(17, object.enrollment.targetId);
          fbb.addInt64(18, object.event.targetId);
          fbb.finish(fbb.endTable());
          return object.id;
        },
        objectFromFB: (obx.Store store, ByteData fbData) {
    ...
    ToRelationship: obx_int.EntityDefinition<ToRelationship>(
        model: _entities[33],
        ...
        objectFromFB: (obx.Store store, ByteData fbData) {
          ...
          final uidParam = const fb.StringReader(asciiOptimization: true)
              .vTableGet(buffer, rootOffset, 14, '');
          final object = ToRelationship(uid: uidParam)
            ..id = const fb.Int64Reader().vTableGet(buffer, rootOffset, 4, 0);
          object.enrollment.targetId =
              const fb.Int64Reader().vTableGet(buffer, rootOffset, 8, 0);
          object.enrollment.attach(store);
    ...
    TrackedEntity: obx_int.EntityDefinition<TrackedEntity>(
        model: _entities[34],
        toOneRelations: (TrackedEntity object) => [],
        toManyRelations: (TrackedEntity object) => {
              obx_int.RelInfo<TrackedEntity>.toMany(24, object.id):
                  object.relationships,
              obx_int.RelInfo<TrackedEntity>.toMany(25, object.id):
                  object.attributes,
        ...
        objectFromFB: (obx.Store store, ByteData fbData) {
          ...
          final object = TrackedEntity(
            ...
            ..id = const fb.Int64Reader().vTableGet(buffer, rootOffset, 4, 0);
          obx_int.InternalToManyAccess.setRelInfo<TrackedEntity>(
              object.relationships,
              store,
              obx_int.RelInfo<TrackedEntity>.toMany(24, object.id));
          obx_int.InternalToManyAccess.setRelInfo<TrackedEntity>(
...
class D2Enrollment_ {
  ...
  static final trackedEntity =
      obx.QueryRelationToOne<D2Enrollment, TrackedEntity>(
          _entities[2].properties[14]);

  /// see [D2Enrollment.relationships]
  static final relationships =
      obx.QueryRelationToMany<D2Enrollment, Relationship>(
...
class D2Event_ {
  ...
  static final trackedEntity = obx.QueryRelationToOne<D2Event, TrackedEntity>(
  ...
  static final relationships =
      obx.QueryRelationToMany<D2Event, Relationship>(_entities[3].relations[0]);
...
class D2TrackedEntityAttributeValue_ {
  ...
  static final trackedEntity =
      obx.QueryRelationToOne<D2TrackedEntityAttributeValue, TrackedEntity>(
...
class DHIS2AttributeValue_ {
  ...
  static final id = obx.QueryIntegerProperty<DHIS2AttributeValue>(
      _entities[30].properties[0]);

  /// see [DHIS2AttributeValue.dataElement]
  static final dataElement =
      obx.QueryRelationToOne<DHIS2AttributeValue, D2DataElement>(
          _entities[30].properties[1]);

  /// see [DHIS2AttributeValue.trackedEntityAttribute]
  static final trackedEntityAttribute =
      obx.QueryRelationToOne<DHIS2AttributeValue, D2TrackedEntityAttribute>(
...
class FromRelationship_ {
  ...
  static final id =
      obx.QueryIntegerProperty<FromRelationship>(_entities[31].properties[0]);

  /// see [FromRelationship.enrollment]
  static final enrollment =
      obx.QueryRelationToOne<FromRelationship, D2Enrollment>(
          _entities[31].properties[1]);

  /// see [FromRelationship.event]
  static final event = obx.QueryRelationToOne<FromRelationship, D2Event>(
      _entities[31].properties[2]);

  /// see [FromRelationship.uid]
  static final uid =
      obx.QueryStringProperty<FromRelationship>(_entities[31].properties[3]);

  /// see [FromRelationship.trackedEntity]
  static final trackedEntity =
      obx.QueryRelationToOne<FromRelationship, TrackedEntity>(
...
class Relationship_ {
  /// see [Relationship.id]
  static final id =
      obx.QueryIntegerProperty<Relationship>(_entities[32].properties[0]);

  /// see [Relationship.uid]
  static final uid =
      obx.QueryStringProperty<Relationship>(_entities[32].properties[1]);

  /// see [Relationship.relationshipName]
  static final relationshipName =
      obx.QueryStringProperty<Relationship>(_entities[32].properties[2]);

  /// see [Relationship.bidirectional]
  static final bidirectional =
      obx.QueryBooleanProperty<Relationship>(_entities[32].properties[3]);

  /// see [Relationship.relationshipType]
  static final relationshipType =
      obx.QueryStringProperty<Relationship>(_entities[32].properties[4]);

  /// see [Relationship.createdAt]
  static final createdAt =
      obx.QueryDateProperty<Relationship>(_entities[32].properties[5]);

  /// see [Relationship.updatedAt]
  static final updatedAt =
      obx.QueryDateProperty<Relationship>(_entities[32].properties[6]);

  /// see [Relationship.to]
  static final to = obx.QueryRelationToOne<Relationship, ToRelationship>(
      _entities[32].properties[7]);

  /// see [Relationship.from]
  static final from = obx.QueryRelationToOne<Relationship, FromRelationship>(
      _entities[32].properties[8]);

  /// see [Relationship.trackedEntity]
  static final trackedEntity =
      obx.QueryRelationToOne<Relationship, TrackedEntity>(
          _entities[32].properties[9]);

  /// see [Relationship.enrollment]
  static final enrollment = obx.QueryRelationToOne<Relationship, D2Enrollment>(
      _entities[32].properties[10]);

  /// see [Relationship.event]
  static final event = obx.QueryRelationToOne<Relationship, D2Event>(
...
class ToRelationship_ {
  ...
  static final id =
      obx.QueryIntegerProperty<ToRelationship>(_entities[33].properties[0]);

  /// see [ToRelationship.enrollment]
  static final enrollment =
      obx.QueryRelationToOne<ToRelationship, D2Enrollment>(
          _entities[33].properties[1]);

  /// see [ToRelationship.event]
  static final event = obx.QueryRelationToOne<ToRelationship, D2Event>(
      _entities[33].properties[2]);

  /// see [ToRelationship.uid]
  static final uid =
      obx.QueryStringProperty<ToRelationship>(_entities[33].properties[3]);

  /// see [ToRelationship.trackedEntity]
  static final trackedEntity =
      obx.QueryRelationToOne<ToRelationship, TrackedEntity>(
...
class TrackedEntity_ {
  ...
  static final id =
      obx.QueryIntegerProperty<TrackedEntity>(_entities[34].properties[0]);

  /// see [TrackedEntity.uid]
  static final uid =
      obx.QueryStringProperty<TrackedEntity>(_entities[34].properties[1]);

  /// see [TrackedEntity.trackedEntityType]
  static final trackedEntityType =
      obx.QueryStringProperty<TrackedEntity>(_entities[34].properties[2]);

  /// see [TrackedEntity.programOwners]
  static final programOwners =
      obx.QueryStringProperty<TrackedEntity>(_entities[34].properties[3]);

  /// see [TrackedEntity.orgUnit]
  static final orgUnit =
      obx.QueryStringProperty<TrackedEntity>(_entities[34].properties[4]);

  /// see [TrackedEntity.createdAtClient]
  static final createdAtClient =
      obx.QueryDateProperty<TrackedEntity>(_entities[34].properties[5]);

  /// see [TrackedEntity.potentialDuplicate]
  static final potentialDuplicate =
      obx.QueryBooleanProperty<TrackedEntity>(_entities[34].properties[6]);

  /// see [TrackedEntity.deleted]
  static final deleted =
      obx.QueryBooleanProperty<TrackedEntity>(_entities[34].properties[7]);

  /// see [TrackedEntity.inactive]
  static final inactive =
      obx.QueryBooleanProperty<TrackedEntity>(_entities[34].properties[8]);

  /// see [TrackedEntity.createdAt]
  static final createdAt =
      obx.QueryDateProperty<TrackedEntity>(_entities[34].properties[9]);

  /// see [TrackedEntity.updatedAt]
  static final updatedAt =
      obx.QueryDateProperty<TrackedEntity>(_entities[34].properties[10]);

  /// see [TrackedEntity.relationships]
  static final relationships =
      obx.QueryRelationToMany<TrackedEntity, Relationship>(
          _entities[34].relations[0]);

  /// see [TrackedEntity.attributes]
  static final attributes =
      obx.QueryRelationToMany<TrackedEntity, D2TrackedEntityAttributeValue>(
          _entities[34].relations[1]);

  /// see [TrackedEntity.enrollments]
  static final enrollments =
      obx.QueryBacklinkToMany<D2Enrollment, TrackedEntity>(
          D2Enrollment_.trackedEntity);

  /// see [TrackedEntity.events]
  static final events =
      obx.QueryBacklinkToMany<D2Event, TrackedEntity>(D2Event_.trackedEntity);
}
